<template>
    <view class="content">
        ...
        <view class="pay">
            ...
            >
                <!-- 充值余额 -->
                <u-form-item label="当前余额(元)" borderBottom>
                    <u-input
                        prefixIcon="rmb"
                        v-model="pay.current"
                        placeholder="当前余额"
...
export default {
    onLoad() {
        ...
        this.pay.current = this.business.money;
    },
    onReady() {
    ...
    data() {
        return {
            message:
                "余额可用于购买商品或用于商城消费或用于悬赏提问，平台提供各种充值优惠",
            ShowType: false,
            business: {},
            TypeList: [
                { name: "微信支付", value: "wx" },
