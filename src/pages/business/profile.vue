    ...
    <view>
        ...
        >
            ...
            <view class="profile">
                ...
                <!-- 地区 -->
                <pick-regions
                    :defaultRegion="business.region_code"
                ...
                >
                    <u-textarea
                        count
                        v-model="business.motto"
                        border="none"
                        placeholder="几句话简单介绍一下自己吧"
                    ></u-textarea>
                </u-form-item>
...
export default {
    ...
    onShow() {
        ...
        // 设置地区
        this.business.region_code =
            this.business.district ||
            this.business.city ||
            this.business.province;

        // 个性签名为空
        if (!this.business.motto) {
            this.business.motto = "";
        }
    },
    ...
    methods: {
        ...
        handleGetRegion(region) {
            this.business.region_text = region
                .map((item) => item.name)
                .join("/");
            ...
            this.$refs.profile
                ...
                .then(async (res) => {
                    ...
                    if (
                        ...
                        this.avatar[0].url != this.business.avatar_text
                    ) {
                        data.name = "avatar";
                    ...
                    var result = await uni.$u.http.upload(
                        "business/profile",
                        data
                    );
