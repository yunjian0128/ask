    ...
    <view>
        ...
        <view class="post">
            ...
            >
                ...
                <!-- 积分 -->
                <u-form-item label="增加悬赏积分：" prop="point" ref="point">
                    <u-input
                        v-model="post.point"
                        placeholder="请输入悬赏积分"
                    ></u-input>
...
export default {
    ...
    onLoad(options) {
        this.postid = options.postid ? options.postid : 0;
    ...
    methods: {
        async PostData() {
            ...
            // 设置默认的选中项
            this.CateData[0].forEach((item, key) => {
        ...
        submit() {
            ...
            this.$refs.post
                ...
                .then(async (res) => {
                    ...
                    // 请求编辑帖子
                    var result = await uni.$u.http.post("/post/edit", data);
